...
function fp({ activeButton: e, buttons: t }) {
  return /* @__PURE__ */ h("span", { className: "isolate inline-flex rounded-[--radius-hello-csv-md] shadow-xs", children: t.map((n, r) => /* @__PURE__ */ h(
    "button",
    {
      type: "button",
      onClick: n.onClick,
